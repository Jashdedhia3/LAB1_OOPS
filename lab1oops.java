package com.gratlearning.test;

import java.util.HashMap;
import java.util.Scanner;

import com.greatlearning.service.CrerdentialServiceImpl;
...
public class TestEmployee {
	...
	public static void main(String[] args) {
		...
		CrerdentialServiceImpl credentialServiceImpl = new CrerdentialServiceImpl();
		String email = "";
